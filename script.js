...
const projects = [
  {
    ...
    technologies: [
      ...
      { name: 'HTML', url: 'https://redux.js.org/' },
       { name: 'CSS', url: 'https://redux.js.org/' },
    ...
    liveVersion: 'http://127.0.0.1:5501/index.html',
    codeSource: 'https://app.netlify.com/sites/euphonious-babka-3beffe/overview',
  },
  {
    ...
    liveVersion: 'http://127.0.0.1:5501/public/index.html',
    codeSource: 'https://console.firebase.google.com/project/weatherpredictionapp-45501/overview',
  },
  {
    ...
    liveVersion: 'https://image-search-a1915.firebaseapp.com/',
    codeSource: 'https://console.firebase.google.com/',
  },
  {
    name: 'Ola-Clone',
    image: './images/@doctors3.png',
    technologies: [
      { name: 'HTML', url: 'https://redux.js.org/' },
       { name: 'CSS', url: 'https://redux.js.org/' },
      // { name: 'JavaScript', url: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript' },
    ],
    liveVersion: 'https://ola-responsive.firebaseapp.com/',
    codeSource: 'https://github.com/juhisingh12/ola-app.github.io',
  },
  {
    name: 'Bigbasket-Clone',
    image: './images/@doctors4.png',
    technologies: [
      { name: 'HTML', url: 'https://redux.js.org/' },
       { name: 'CSS', url: 'https://redux.js.org/' },
      // { name: 'JavaScript', url: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript' },
    ],
    liveVersion: 'https://bigbasket-responsive.firebaseapp.com/',
    codeSource: 'https://github.com/juhisingh12/bigbasket.github.io',
  },
  // {
...
for (let i = 0; i < projects.length; i += 1) {
  ...
  popupSourceLinks[i].innerHTML = 'See Deploy';
...
consoleText(['Web Developer.', 'JavaScript Developer.'], 'text', 'text-mobile');
